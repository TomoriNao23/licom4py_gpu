...
class TimeConfig:
    ...
    start_month: Optional[int] = field(
        default=None, metadata={"section": "time_params"}
    )
    ...
    start_second: Optional[int] = field(
        default=None, metadata={"section": "time_params"}
    )

    # Integration time parameters (all optional, but at least one must be specified)
    integration_years: Optional[int] = field(
        default=None, metadata={"section": "time_params"}
    )
    integration_months: Optional[int] = field(
        default=None, metadata={"section": "time_params"}
    )
    integration_days: Optional[int] = field(
        default=None, metadata={"section": "time_params"}
    )
    integration_hours: Optional[int] = field(
        default=None, metadata={"section": "time_params"}
    )
    integration_minutes: Optional[int] = field(
        default=None, metadata={"section": "time_params"}
    )
    integration_seconds: Optional[int] = field(
        default=None, metadata={"section": "time_params"}
    )
